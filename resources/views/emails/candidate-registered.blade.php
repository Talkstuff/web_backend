...
<head>
    ...
    <style>
        ...
        .ribbed-white {
            background: #ffffff -webkit-linear-gradient(135deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent) !important;
        ...
        .ribbed-lightTeal {
            background: #45fffd -webkit-linear-gradient(135deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent) !important;
        ...
        .ribbed-lightCyan {
            background: #59cde2 -webkit-linear-gradient(135deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent) !important;
        ...
        .ribbed-grayLighter {
            background: #eeeeee -webkit-linear-gradient(135deg, rgba(255, 255, 255, 0.15) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.15) 50%, rgba(255, 255, 255, 0.15) 75%, transparent 75%, transparent) !important;
        ...
        /*# sourceMappingURL=metro.lite.css.map */
...
<div class="uk-width-1-1">
    <div class="uk-width-large uk-margin-auto">
        <div class="uk-width-1-1 uk-light uk-padding bg-lighterGray uk-text-center uk-flex uk-flex-center">
            <img src="{{url('shared/images/tslogo.png')}}" alt="TalkStuff">
        </div>

        <div class="uk-width-1-1">
            <h3 class="fg-darkGreen">Hello, {{$cast->name}}</h3>
